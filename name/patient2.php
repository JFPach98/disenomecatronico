...
<body id="reportsPage">
                ...
                <div class="col-12">
                    <nav class="navbar navbar-expand-xl navbar-light bg-light">
                        <a class="navbar-brand" href="#">
                            <h1 class="tm-site-title mb-0">I. M. Postor</h1>
                        </a>
            ...
            <div class="row tm-content-row tm-mt-big">
                ...
                <div class="tm-col tm-col-big">
                    <div class="bg-white tm-block h-100">
                        ...
                        <p>Average Cardiac Rhythm: 109 bpm</p>
                        <p>Average Oxygen Saturation: 93%</p>
                        <p>Last month:</p>
                ...
                <div class="tm-col tm-col-small" style='background: rgb(250, 220, 27)'>
                    <div class="bg-white tm-block h-100">
                        <h2 class="tm-block-title">Status</h2>
                        <canvas id="pieChart" class="chartjs-render-monitor" style='display: none' ></canvas>
                        <img src="/images/impostor.jpg" alt="Italian Trulli" style="width:200px;height:112.5px;">
                        <p>Middle risk</p>
                    </div>
                </div>
    ...
    <!-- https://getbootstrap.com/ -->
    <script src="js/tooplate-scripts1.js"></script>
    <script>
        let ctxLine,
            ctxBar,
            ctxPie,
